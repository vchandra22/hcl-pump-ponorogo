                ...
                {filteredAbout.length === 0 ? (
                    <div className="flex min-h-5/6 items-center justify-center pb-20">
                        <EmptyState
                            ...
                            description={
                                searchTerm ? 'Tidak ada About Us yang sesuai dengan pencarian Anda' : 'Mulai dengan menambahkan About Us baru'
                            }
                            action={
                                <Button asChild>
                                    <Link href="/about-us/create">
                                                ...
                                                <AlertDialogContent>
                                                    ...
                                                    <AlertDialogFooter>
                                                        ...
                                                        <AlertDialogAction asChild>
                                                            <Link href={`/about-us/${item.id}/delete`} method="delete" as="button" preserveScroll>
                                                                Hapus
                                                            </Link>
                                                        </AlertDialogAction>
                                                    </AlertDialogFooter>
